...
void test1()
{
	...
	cout<<"&bb1="<<&bb1<<endl;
	cout<<"&ib1="<<(int*)&bb1.ib1<<endl;
	cout<<"&cb1="<<(int*)&bb1.cb1<<endl;
	cout<<"&ib ="<<(int*)&bb1.ib<<endl;
	cout<<"&cb ="<<(int*)&bb1.cb<<endl;
	...
	cout << "[5] = 0x";
	cout << (int*)*((int*)(&bb1)+5) << endl; //NULL

	cout << "[5] B::_vptr->" << endl;
	cout << "     [0] ";
	cout << "0x" << (Fun)pVtab[5][0] << endl;
// 	pFun = (Fun)pVtab[5][0];
// 	cout << "     [0] ";
// 	pFun(); //B1::f();
	pFun = (Fun)pVtab[5][1];
...
>cl Ðéº¯Êý×êÊ¯ÐÍÐéÄâ¼Ì³Ð.cpp /d1reportSingleClassLayoutD
*/
